...
<section class="content-header">
    <h3>
        <b> Reporte de plagas <i class="fa fa-cubes"></i> </b>
    </h3>
</section>
<div class="content">
    <div class="col-md-13">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-success">
                    <div class="ibox-head">
                        <div class="ibox-title">Reporte de plagas </div>
                    </div>
                    <div class="ibox-body">
                        <div class="row">
                            ...
                            <div class="col-lg-1">
                                <label>Buscar</label>
                                <button class="btn btn-primary" onclick="reprote_plagas();"><i class="fa fa-eye"></i></button>
                            </div>
...
<script>
    ...
    function reprote_plagas() {
        ...
        ifrm.setAttribute("src", "../ADMIN/REPORTES/Pdf/Reportes/reporte_plagas.php?f_i='" + fecha_inicio + "'&f_f='" + fecha_fin + "'");
