...
<section class="content-header">
    <h3>
        <b> Reporte de commpras materiales <i class="fa fa-cubes"></i> </b>
    </h3>
</section>
<div class="content">
    <div class="col-md-13">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-success">
                    <div class="ibox-head">
                        <div class="ibox-title">Reporte de commpras materiales </div>
                    </div>
                    <div class="ibox-body">
                        <div class="row">
...
<script>
    ...
    function reprote_compras() {
        ...
        ifrm.setAttribute("src", "../ADMIN/REPORTES/Pdf/Reportes/reportes_compras.php?f_i='" + fecha_inicio + "'&f_f='" + fecha_fin + "'");
