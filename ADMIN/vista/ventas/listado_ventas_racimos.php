...
<section class="content-header">
    <h3>
        <b> Listado de ventas racimos <i class="fa fa-list"></i> </b>
    </h3>
</section>
        ...
        <div class="box box-warning box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-warning">
                    <div class="ibox-head">
                        <div class="ibox-title">Lista de ventas racimos</div>
                    </div>
                    <div class="ibox-body">

                        <table id="tabla_ventas_racimos" class="display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background: #3c8dbc; color:white;">
                    <h4 class="modal-title"><i class="fa fa-cubes"></i> Detalle venta racimos</h4>
                </div>
