...
<section class="content-header">
    <h3>
        <b> Asistencia por empleado <i class="fa fa-user" style="color:red;"></i> </b>
    </h3>
</section>
        ...
        <div class="box box-warning box-solid">
            ...
            <div class="box-body">
                <div class="ibox ibox-warning">
                    <div class="ibox-head">
                        <div class="ibox-title"> Detalle de asistencia del empleado</div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="ibox-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <input type="text" maxlength="10" class="form-control" id="numero_docu_a" placeholder="Ingrese numero de cedula" onkeypress="return soloNumeros(event)">
                                    </div>
                            ...
                            <div class="ibox-body">
                                <div class="row align-items-center">
                                    ...
                                    <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="tbody_detalle_asistenia">
...
<script>
    $("#numero_docu_a").keyup(function() {
        var valor = this.value;
        var funcion = "traer_datos_empleado_asistencias";
        ...
        $.ajax({
            ...
            if (resp != 0) {
                ...
                traer_el_empleado_asistencias(id);
            } else {
                $("#id_empleado").val("");
                $("#nombres").val("");
                $("#apellidos").val("");
                ...
                $("#estado_empleado").html("");
                $("#tbody_detalle_asistenia").empty();
            }
        });
    });

    function traer_el_empleado_asistencias(id) {
        funcion = "traer_el_empleado_asistencias";
        $.ajax({
            url: "../ADMIN/controlador/asistencias/asistencias.php",
            type: "POST",
            data: {
            ...
            if (resp != 0) {
                ...
                data["data"].forEach(row => {
                    ...
                    if (row["estado_asistencia"] == 0) {
                        estado = "ENTRADA Y SALIDA MARCADA";
                    } else {
                ...
                <td for='id'>${count}</td>
                <td>${estado}</td>
                <td>${row["fecha_hora_ingreso"]}</td>
                <td>${row["fecha_hora_salida"]}</td>                        
                </tr>`

                    $("#tbody_detalle_asistenia").html(llenat);
                });
