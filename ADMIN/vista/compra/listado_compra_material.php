...
<section class="content-header">
    <h3>
        <b> Listado de compras material <i class="fa fa-list"></i> </b>
    </h3>
</section>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Lista de compras material</div>
                    </div>
                    <div class="ibox-body">

                        <table id="tabla_compras_material_" class="display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
...
<form autocomplete="false" onsubmit="return false">
    <div class="modal fade" id="modal_detalle_comppra" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background: #3c8dbc; color:white;">
                    <h4 class="modal-title"><i class="fa fa-cubes"></i> Detalle compra material</h4>
                </div>
