...
while ($row = $result->fetch_assoc()) {
    ...
    <div style="text-align:center;"><h1><u>REPORTE DE COMPRAS MATERIAL</u></h1></div><br>
    ...
    $html .= '<div style="width:700px; text-align:center;">
                    <h2><u>Detalle compras material</u></h2>
            </div>
    ...
    FROM
        ...
        WHERE compra_material.estado = 1 AND
	compra_material.fecha BETWEEN ' . $f_i . ' AND  ' . $f_f . '';
