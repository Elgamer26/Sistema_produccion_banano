...
while ($row = $result->fetch_assoc()) {
    ...
    <div style="text-align:center;"><h1><u>REPORTE DE VENTAS RACIMOS</u></h1></div><br>
    ...
    $html .= '<div style="width:700px; text-align:center;">
                    <h2><u>Detalle ventas racimos</u></h2>
            </div>
    ...
    INNER JOIN cliente ON venta_racimos.id_cliente = cliente.id_cliente
        WHERE venta_racimos.estado = 1 AND
        venta_racimos.fecha_venta BETWEEN ' . $f_i . ' AND  ' . $f_f . '';
